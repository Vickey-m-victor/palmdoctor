        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Palm DOC</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="index.php"><i class="fa fa-oard"></i> <span>Dashboard</span></a>
                        </li>
						<li>
                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="assets/img/logo.png" alt=""></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo $user_data['user_name'];?></h3>
                                                <small class="text-muted"><?php echo $user_data['spec'];?></small>
                                                <div class="staff-id">Employee ID : <?php echo $user_data['id'];?></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">+254<?php echo $user_data['mobile'];?></a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $user_data['birthday'];?></span>
                                                </li>
                                                <li>
                                                    <span class="title">Gender:</span>
                                                    <span class="text"><?php echo $user_data['gender'];?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
